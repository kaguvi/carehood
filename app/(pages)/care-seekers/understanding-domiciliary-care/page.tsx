  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p>
        ...
        personal care due to illness, disability, or old age. The primary aim of domiciliary care is to help people maintain
      ...
      <p>
        While both domiciliary care and residential care provide support for individuals with care needs, there are key differences:
      </p>
      <ul className="list-disc list-outside ml-4">
        <li>Domiciliary care is provided in the individual&apos;s own home, while residential care is provided in a care home setting.</li>
        <li>Domiciliary care allows for more personalized and flexible care plans tailored to individual needs and preferences.</li>
        <li>Residential care offers 24/7 support and may be more suitable for individuals with complex care needs or advanced dementia.</li>
      </ul>
